export function drawLaserTowerLevel3Base(ctx, cx, cy, tileSize) {
  ctx.save();
  ctx.translate(cx, cy);
  ...
  ctx.fillRect(-tileSize * 0.13, -tileSize * 0.18, tileSize * 0.26, tileSize * 0.10);
  ctx.strokeStyle = '#b2ff59';
  ctx.lineWidth = 2;
  ctx.strokeRect(-tileSize * 0.13, -tileSize * 0.18, tileSize * 0.26, tileSize * 0.10);
  // Panel lines
  ctx.strokeStyle = '#b2ff59';
  ctx.lineWidth = 2;
  ctx.beginPath();
...
export function drawLaserTowerLevel3Turret(ctx, cx, cy, tileSize, angle) {
  ctx.save();
  ctx.translate(cx, cy);
  ctx.rotate(angle);
  // Blocky barrel, with green highlight
  ctx.fillStyle = '#66bb6a';
  ctx.fillRect(tileSize * 0.10, -tileSize * 0.06, tileSize * 0.24, tileSize * 0.12);
  ctx.strokeStyle = '#388e3c';
  ctx.lineWidth = 2;
  ctx.strokeRect(tileSize * 0.10, -tileSize * 0.06, tileSize * 0.24, tileSize * 0.12);
  // Green highlight line
  ctx.strokeStyle = '#b2ff59';
  ctx.lineWidth = 2;
  ctx.beginPath();
  ctx.moveTo(tileSize * 0.10, 0);
  ctx.lineTo(tileSize * 0.34, 0);
  ctx.stroke();
